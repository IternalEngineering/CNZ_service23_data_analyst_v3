#!/usr/bin/env python
"""
Test script for city insights analyzer - Gemini version
...
async def test_analyzer():
    """Test the city insights analyzer with Gemini"""
    print("\n" + "="*60)
    print("Testing City Insights Analyzer (Gemini Version)")
    print("="*60)
    ...
    print(f"  Model: Google Gemini 1.5 Pro (2M context)")
